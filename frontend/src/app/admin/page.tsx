      ...
      <aside className="w-64 flex flex-col border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-background-dark shrink-0">
        <div className="p-6 flex items-center gap-3">
          {currentAdminRole === 'super_admin' ? (
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary via-rose-500 to-amber-500 flex items-center justify-center text-white shadow-md shadow-primary/20 flex-shrink-0">
                <span className="material-symbols-outlined text-2xl select-none">sports_score</span>
              </div>
              <div className="flex flex-col leading-none">
                <h2 className="text-base font-black tracking-tight text-slate-900 dark:text-white uppercase">Tienda Deportiva</h2>
                <span className="text-[10px] font-bold text-primary tracking-widest uppercase mt-0.5">y Accesorios Admin</span>
              </div>
            </div>
          )}
        </div>
