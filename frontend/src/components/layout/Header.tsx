      ...
      <div className="px-6 lg:px-12 h-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 md:gap-6 flex-shrink-0">
          ...
          <div className="hidden md:flex items-center gap-3">
            <a href="https://wa.me/5493704747426" target="_blank" rel="noopener noreferrer" className="p-2 text-slate-500 hover:text-green-500 hover:bg-green-50 dark:hover:bg-green-900/20 rounded-full transition-colors">
          ...
          <div className="relative">
            ...
            {isDropdownOpen && user && (
              <div className="absolute top-full mt-4 right-0 w-56 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl shadow-xl overflow-hidden py-2 animate-in fade-in slide-in-from-top-2">
                ...
                <Link onClick={() => setIsDropdownOpen(false)} href="/profile/orders" className="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-primary transition-colors">
                  <Package className="w-4 h-4" /> Mis Pedidos
                </Link>
                <button 
                  onClick={() => { setIsDropdownOpen(false); openCart(); }} 
                  className="w-full flex items-center justify-between px-4 py-2.5 text-sm text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-primary transition-colors text-left"
                >
