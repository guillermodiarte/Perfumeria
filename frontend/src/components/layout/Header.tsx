      ...
      <div className="px-6 lg:px-12 h-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 md:gap-6 flex-shrink-0">
          ...
          <div className="hidden md:flex items-center gap-3">
            <a href="https://wa.me/5493513146924" target="_blank" rel="noopener noreferrer" className="p-2 text-slate-500 hover:text-green-500 hover:bg-green-50 dark:hover:bg-green-900/20 rounded-full transition-colors">
