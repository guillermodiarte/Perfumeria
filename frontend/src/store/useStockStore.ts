...
const MOCK_PRODUCTS: Product[] = [
  // Body Spray
  { id: 'b1', name: 'Body Splash Tropical 1', sku: 'BODY-01', categoryId: 'Body Splash', purchasePrice: 6000, salePrice: 12000, imageUrls: ['https://perfumeria-app-npomsb-0df670-76-13-71-212.traefik.me/uploads/BodySpray/1.jpeg'], variants: [{ id: 'vb1', size: '200ml', color: 'Único', stock: 10 }] },
  { id: 'b2', name: 'Body Splash Floral 2', sku: 'BODY-02', categoryId: 'Body Splash', purchasePrice: 6000, salePrice: 12000, imageUrls: ['https://perfumeria-app-npomsb-0df670-76-13-71-212.traefik.me/uploads/BodySpray/2.jpeg'], variants: [{ id: 'vb2', size: '200ml', color: 'Único', stock: 15 }] },
  { id: 'b3', name: 'Body Splash Citric 3', sku: 'BODY-03', categoryId: 'Body Splash', purchasePrice: 6000, salePrice: 12000, imageUrls: ['https://perfumeria-app-npomsb-0df670-76-13-71-212.traefik.me/uploads/BodySpray/3.jpeg'], variants: [{ id: 'vb3', size: '200ml', color: 'Único', stock: 12 }] },
  { id: 'b4', name: 'Body Splash Sweet 4', sku: 'BODY-04', categoryId: 'Body Splash', purchasePrice: 6000, salePrice: 12000, imageUrls: ['https://perfumeria-app-npomsb-0df670-76-13-71-212.traefik.me/uploads/BodySpray/4.jpeg'], variants: [{ id: 'vb4', size: '200ml', color: 'Único', stock: 20 }] },
  { id: 'b5', name: 'Body Splash Fresh 5', sku: 'BODY-05', categoryId: 'Body Splash', purchasePrice: 6000, salePrice: 12000, imageUrls: ['https://perfumeria-app-npomsb-0df670-76-13-71-212.traefik.me/uploads/BodySpray/5.jpeg'], variants: [{ id: 'vb5', size: '200ml', color: 'Único', stock: 8 }] },

  // Labiales
  { id: 'l1', name: 'Labial Matte 1', sku: 'LAB-01', categoryId: 'Labios', purchasePrice: 4000, salePrice: 8500, imageUrls: ['https://perfumeria-app-npomsb-0df670-76-13-71-212.traefik.me/uploads/Labiales/1.jpeg'], variants: [{ id: 'vl1', size: 'Único', color: 'Rojo', stock: 25 }] },
  { id: 'l2', name: 'Labial Matte 2', sku: 'LAB-02', categoryId: 'Labios', purchasePrice: 4000, salePrice: 8500, imageUrls: ['https://perfumeria-app-npomsb-0df670-76-13-71-212.traefik.me/uploads/Labiales/2.jpeg'], variants: [{ id: 'vl2', size: 'Único', color: 'Rosa', stock: 15 }] },
  { id: 'l3', name: 'Labial Gloss 3', sku: 'LAB-03', categoryId: 'Labios', purchasePrice: 4500, salePrice: 9000, imageUrls: ['https://perfumeria-app-npomsb-0df670-76-13-71-212.traefik.me/uploads/Labiales/3.jpeg'], variants: [{ id: 'vl3', size: 'Único', color: 'Nude', stock: 30 }] },
  { id: 'l4', name: 'Labial Cream 4', sku: 'LAB-04', categoryId: 'Labios', purchasePrice: 4000, salePrice: 8500, imageUrls: ['https://perfumeria-app-npomsb-0df670-76-13-71-212.traefik.me/uploads/Labiales/4.jpeg'], variants: [{ id: 'vl4', size: 'Único', color: 'Coral', stock: 10 }] },
  { id: 'l5', name: 'Labial Velvet 5', sku: 'LAB-05', categoryId: 'Labios', purchasePrice: 5000, salePrice: 9500, imageUrls: ['https://perfumeria-app-npomsb-0df670-76-13-71-212.traefik.me/uploads/Labiales/5.jpeg'], variants: [{ id: 'vl5', size: 'Único', color: 'Vino', stock: 5 }] },

  // Perfumes
  { id: 'p1', name: 'Perfume Elegance 1', sku: 'PERF-01', categoryId: 'Perfumes de Mujer', purchasePrice: 30000, salePrice: 55000, imageUrls: ['https://perfumeria-app-npomsb-0df670-76-13-71-212.traefik.me/uploads/Perfumes/1.jpeg'], variants: [{ id: 'vp1', size: '100ml', color: 'Único', stock: 10 }] },
  { id: 'p2', name: 'Perfume Classic 2', sku: 'PERF-02', categoryId: 'Perfumes de Hombre', purchasePrice: 32000, salePrice: 60000, imageUrls: ['https://perfumeria-app-npomsb-0df670-76-13-71-212.traefik.me/uploads/Perfumes/2.jpeg'], variants: [{ id: 'vp2', size: '100ml', color: 'Único', stock: 8 }] },
  { id: 'p3', name: 'Perfume Intense 3', sku: 'PERF-03', categoryId: 'Perfumes de Mujer', purchasePrice: 28000, salePrice: 50000, imageUrls: ['https://perfumeria-app-npomsb-0df670-76-13-71-212.traefik.me/uploads/Perfumes/3.jpeg'], variants: [{ id: 'vp3', size: '50ml', color: 'Único', stock: 12 }] },
  { id: 'p4', name: 'Perfume Night 4', sku: 'PERF-04', categoryId: 'Perfumes de Hombre', purchasePrice: 35000, salePrice: 65000, imageUrls: ['https://perfumeria-app-npomsb-0df670-76-13-71-212.traefik.me/uploads/Perfumes/4.jpeg'], variants: [{ id: 'vp4', size: '100ml', color: 'Único', stock: 6 }] },
  { id: 'p5', name: 'Perfume Fresh 5', sku: 'PERF-05', categoryId: 'Unisex', purchasePrice: 25000, salePrice: 48000, imageUrls: ['https://perfumeria-app-npomsb-0df670-76-13-71-212.traefik.me/uploads/Perfumes/5.jpeg'], variants: [{ id: 'vp5', size: '100ml', color: 'Único', stock: 15 }] },
  { id: 'p6', name: 'Perfume Gold 6', sku: 'PERF-06', categoryId: 'Perfumes de Mujer', purchasePrice: 40000, salePrice: 75000, imageUrls: ['https://perfumeria-app-npomsb-0df670-76-13-71-212.traefik.me/uploads/Perfumes/6.jpeg'], variants: [{ id: 'vp6', size: '50ml', color: 'Único', stock: 4 }] },
  { id: 'p7', name: 'Perfume Sport 7', sku: 'PERF-07', categoryId: 'Perfumes de Hombre', purchasePrice: 27000, salePrice: 49000, imageUrls: ['https://perfumeria-app-npomsb-0df670-76-13-71-212.traefik.me/uploads/Perfumes/7.jpeg'], variants: [{ id: 'vp7', size: '100ml', color: 'Único', stock: 20 }] },
];
